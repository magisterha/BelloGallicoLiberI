const corpus = {
    ...
    introductio: {
        ...
        zh: {
            titulus: "第 9 章介紹",
            contentus: `<p>在本章中，凱撒詳細描述了赫爾維蒂人剩下的唯一路線：通過塞夸尼人的領土。由於地形狹窄，未經他們同意無法通過，赫爾維蒂人訴諸外交。他們派使團前往杜姆諾里克斯，一位極具影響力的埃杜伊貴族，請求他為他們斡旋。凱撒描述了杜姆諾里克斯的動機：他的權力、他的聯盟（他娶了奧格托里克斯的女兒）、他統治的野心，以及他希望通過恩惠盡可能多地將各個部落與自己聯繫在一起的願望。</p>`
        }
    },
    textus: {
        id: 9,
                ...
                orationes: [
                    {
                        ...
                        verba: [
                            ...
                            { textus: "una", lemma: "unus", morphologia: "Adjetivo, nominativo femenino singular", syntaxis: "Atributo de 'uia'", translatio: { es: "una (sola)", en: "one", zh: "一條" } },
                            ...
                            { textus: "inuitis", lemma: "invitus", morphologia: "Adjetivo, ablativo masculino plural", syntaxis: "Atributo (Ablativo absoluto)", translatio: { es: "en contra de su voluntad", en: "being unwilling", zh: "不情願" } },
                            { textus: "propter", lemma: "propter", morphologia: "Preposición (+ acusativo)", syntaxis: "Preposición", translatio: { es: "a causa de", en: "because of", zh: "由於" } },
                            { textus: "angustias", lemma: "angustiae", morphologia: "Sustantivo, acusativo femenino plural", syntaxis: "Complemento regido por 'propter'", translatio: { es: "la estrechez", en: "the narrows", zh: "狹窄" } },
                            ...
                            { textus: "poterant", lemma: "possum", morphologia: "Verbo, 3ª p. pl., pretérito imperfecto activo, indicativo", syntaxis: "Verbo de la subordinada", translatio: { es: "podían", en: "they could", zh: "能夠" } },
                            { textus: ".", lemma: ".", morphologia: "Signo de puntuación", syntaxis: "Puntuación", translatio: { es: ".", en: ".", zh: "。" } }
                        ],
                        ...
                        translationes: {
                            ...
                            zh: "只剩下通過塞夸尼人領土的一條路，但由於通道狹窄，如果塞夸尼人不同意，他們就無法通過。"
                        }
                    },
                    {
                        id_orationis: 'o2',
                        ...
                        verba: [
                            { textus: "His", lemma: "hic", morphologia: "Pronombre demostrativo, dativo masculino plural", syntaxis: "Complemento Indirecto de 'persuadere'", translatio: { es: "a estos", en: "these", zh: "對他們" } },
                            { textus: "cum", lemma: "cum", morphologia: "Conjunción subordinante", syntaxis: "Nexo (cum histórico)", translatio: { es: "como / puesto que", en: "since", zh: "由於" } },
                            { textus: "sua", lemma: "suus", morphologia: "Adjetivo posesivo, ablativo femenino singular", syntaxis: "Atributo de 'sponte'", translatio: { es: "su propia", en: "their own", zh: "他們自己的" } },
                            { textus: "sponte", lemma: "spons", morphologia: "Sustantivo, ablativo femenino singular", syntaxis: "C.C. de Modo", translatio: { es: "por iniciativa", en: "initiative / will", zh: "主動地" } },
                            { textus: "persuadere", lemma: "persuadeo", morphologia: "Verbo, infinitivo presente activo", syntaxis: "Infinitivo (verbo principal de la subordinada)", translatio: { es: "persuadir", en: "to persuade", zh: "說服" } },
                            { textus: "non", lemma: "non", morphologia: "Adverbio de negación", syntaxis: "Modificador verbal", translatio: { es: "no", en: "not", zh: "不" } },
                            { textus: "possent", lemma: "possum", morphologia: "Verbo, 3ª p. pl., pretérito imperfecto activo, subjuntivo", syntaxis: "Verbo de la subordinada", translatio: { es: "pudieran", en: "they were able", zh: "能夠" } },
                            { textus: ",", lemma: ",", morphologia: "Signo de puntuación", syntaxis: "Puntuación", translatio: { es: ",", en: ",", zh: "，" } },
                            ...
                            { textus: "Dumnorigem", lemma: "Dumnorix", morphologia: "Sustantivo, acusativo masculino singular", syntaxis: "Complemento regido por 'ad'", translatio: { es: "Dúmnorix", en: "Dumnorix", zh: "杜姆諾里克斯" } },
                            ...
                            { textus: "deprecatore", lemma: "deprecator", morphologia: "Sustantivo, ablativo masculino singular", syntaxis: "Atributo (Ablativo absoluto)", translatio: { es: "como intercesor", en: "as intercessor", zh: "作為調解人" } },
                            { textus: "a", lemma: "a/ab", morphologia: "Preposición (+ ablativo)", syntaxis: "Preposición", translatio: { es: "de", en: "from", zh: "從" } },
                            ...
                            { textus: "impetrarent", lemma: "impetro", morphologia: "Verbo, 3ª p. pl., pretérito imperfecto activo, subjuntivo", syntaxis: "Verbo de la subordinada final", translatio: { es: "obtuvieran", en: "they might obtain (their request)", zh: "獲得" } },
                            { textus: ".", lemma: ".", morphologia: "Signo de puntuación", syntaxis: "Puntuación", translatio: { es: ".", en: ".", zh: "。" } }
                        ],
                        ...
                        translationes: {
                            ...
                            zh: "由於無法靠自己的力量說服他們，他們便派遣使者去見埃杜伊人杜姆諾里克斯，以便通過他的斡旋，從塞夸尼人那裡獲得許可。"
                        }
                    },
                    {
                        id_orationis: 'o3',
                        ...
                        verba: [
                            { textus: "Dumnorix", lemma: "Dumnorix", morphologia: "Sustantivo, nominativo masculino singular", syntaxis: "Sujeto", translatio: { es: "Dúmnorix", en: "Dumnorix", zh: "杜姆諾里克斯" } },
                            { textus: "gratia", lemma: "gratia", morphologia: "Sustantivo, ablativo femenino singular", syntaxis: "C.C. de Causa/Medio", translatio: { es: "por su influencia", en: "by his influence", zh: "憑藉影響力" } },
                            { textus: "et", lemma: "et", morphologia: "Conjunción copulativa", syntaxis: "Nexo", translatio: { es: "y", en: "and", zh: "和" } },
                            { textus: "largitione", lemma: "largitio", morphologia: "Sustantivo, ablativo femenino singular", syntaxis: "C.C. de Causa/Medio", translatio: { es: "por su generosidad", en: "by his bribery/generosity", zh: "憑藉慷慨" } },
                            ...
                            { textus: "plurimum", lemma: "multus", morphologia: "Adverbio (superlativo)", syntaxis: "Modificador verbal", translatio: { es: "muchísimo", en: "very much / most", zh: "極大地" } },
                            { textus: "poterat", lemma: "possum", morphologia: "Verbo, 3ª p. sg., pretérito imperfecto activo, indicativo", syntaxis: "Verbo copulativo (poder/influencia)", translatio: { es: "podía / valía", en: "he was very powerful", zh: "有權勢" } },
                            { textus: "et", lemma: "et", morphologia: "Conjunción copulativa", syntaxis: "Nexo", translatio: { es: "y", en: "and", zh: "並且" } },
                            { textus: "Heluetiis", lemma: "Helvetii", morphologia: "Sustantivo, dativo masculino plural", syntaxis: "Complemento de 'amicus'", translatio: { es: "para los helvecios", en: "to the Helvetii", zh: "對赫爾維蒂人" } },
                            ...
                            { textus: "ex", lemma: "ex", morphologia: "Preposición (+ ablativo)", syntaxis: "Preposición", translatio: { es: "de", en: "from", zh: "從" } },
                            { textus: "ea", lemma: "is", morphologia: "Pronombre, ablativo femenino singular", syntaxis: "Atributo de 'ciuitate'", translatio: { es: "esa", en: "that", zh: "那個" } },
                            ...
                            { textus: "Orgetorigis", lemma: "Orgetorix", morphologia: "Sustantivo, genitivo masculino singular", syntaxis: "Complemento del Nombre de 'filiam'", translatio: { es: "de Orgétorix", en: "of Orgetorix", zh: "奧格托里克斯的" } },
                            { textus: "filiam", lemma: "filia", morphologia: "Sustantivo, acusativo femenino singular", syntaxis: "Objeto Directo de 'duxerat'", translatio: { es: "a la hija", en: "the daughter", zh: "女兒" } },
                            { textus: "in", lemma: "in", morphologia: "Preposición (+ acusativo)", syntaxis: "Preposición", translatio: { es: "en", en: "in", zh: "作為" } },
                            ...
                            { textus: "cupiditate", lemma: "cupiditas", morphologia: "Sustantivo, ablativo femenino singular", syntaxis: "C.C. de Causa", translatio: { es: "por el deseo", en: "by the desire", zh: "由於渴望" } },
                            { textus: "regni", lemma: "regnum", morphologia: "Sustantivo, genitivo neutro singular", syntaxis: "Complemento del Nombre de 'cupiditate'", translatio: { es: "de reinar", en: "of kingship", zh: "王權" } },
                            { textus: "adductus", lemma: "adduco", morphologia: "Participio, perfecto pasivo, nominativo masculino singular", syntaxis: "Participio concertado con el sujeto", translatio: { es: "movido / inducido", en: "influenced", zh: "被驅使" } },
                            ...
                            { textus: "rebus", lemma: "res", morphologia: "Sustantivo, dativo femenino plural", syntaxis: "Complemento de 'studebat'", translatio: { es: "(ver 'nouis')", en: "(see 'nouis')", zh: "（見'nouis'）" } },
                            { textus: "studebat", lemma: "studeo", morphologia: "Verbo, 3ª p. sg., pretérito imperfecto activo, indicativo", syntaxis: "Verbo", translatio: { es: "aspiraba a", en: "he was eager for", zh: "熱衷於" } },
                            { textus: "et", lemma: "et", morphologia: "Conjunción copulativa", syntaxis: "Nexo", translatio: { es: "y", en: "and", zh: "並且" } },
                            { textus: "quam plurimas", lemma: "quam plurimus", morphologia: "Locución adjetival, acusativo femenino plural", syntaxis: "Atributo de 'ciuitates'", translatio: { es: "al mayor número posible de", en: "as many as possible", zh: "盡可能多的" } },
                            ...
                            { textus: "habere", lemma: "habeo", morphologia: "Verbo, infinitivo presente activo", syntaxis: "Verbo de la oración de infinitivo", translatio: { es: "tener", en: "to have", zh: "擁有" } },
                            { textus: "obstrictas", lemma: "obstringo", morphologia: "Participio, perfecto pasivo, acusativo femenino plural", syntaxis: "Predicativo del sujeto de la oración de infinitivo", translatio: { es: "obligadas / vinculadas", en: "bound", zh: "束縛" } },
                        ...
                        translationes: {
                            ...
                            zh: "杜姆諾里克斯憑藉其影響力和慷慨，在塞夸尼人中極有權勢，並且是赫爾維蒂人的朋友，因為他從那個部落娶了奧格托里克斯的女兒為妻；而且，在王權欲望的驅使下，他熱衷於變革，並希望通過自己的恩惠盡可能多地將各個部落維繫在自己身邊。"
                        }
                    },
                    {
                        id_orationis: 'o4',
                        ...
                        verba: [
                            ...
                            { textus: "rem", lemma: "res", morphologia: "Sustantivo, acusativo femenino singular", syntaxis: "Objeto Directo", translatio: { es: "el asunto", en: "the task", zh: "這件事" } },
                            { textus: "suscipit", lemma: "suscipio", morphologia: "Verbo, 3ª p. sg., presente activo, indicativo", syntaxis: "Verbo", translatio: { es: "emprende", en: "he undertakes", zh: "承擔" } },
                            { textus: "et", lemma: "et", morphologia: "Conjunción copulativa", syntaxis: "Nexo", translatio: { es: "y", en: "and", zh: "並且" } },
                            { textus: "a", lemma: "a/ab", morphologia: "Preposición (+ ablativo)", syntaxis: "Preposición", translatio: { es: "de", en: "from", zh: "從" } },
                            { textus: "Sequanis", lemma: "Sequani", morphologia: "Sustantivo, ablativo masculino plural", syntaxis: "Complemento regido por 'a'", translatio: { es: "los sécuanos", en: "the Sequani", zh: "塞夸尼人" } },
                            { textus: "impetrat", lemma: "impetro", morphologia: "Verbo, 3ª p. sg., presente activo, indicativo", syntaxis: "Verbo", translatio: { es: "obtiene", en: "he obtains (his request)", zh: "獲得" } },
                            { textus: "ut", lemma: "ut", morphologia: "Conjunción subordinante", syntaxis: "Nexo (completivo)", translatio: { es: "que", en: "that", zh: "讓" } },
                            { textus: "per", lemma: "per", morphologia: "Preposición (+ acusativo)", syntaxis: "Preposición", translatio: { es: "a través de", en: "through", zh: "通過" } },
                            ...
                            { textus: "suos", lemma: "suus", morphologia: "Adjetivo posesivo, acusativo masculino plural", syntaxis: "Atributo de 'fines'", translatio: { es: "suyo", en: "their", zh: "他們的" } },
                            { textus: "Heluetios", lemma: "Helvetii", morphologia: "Sustantivo, acusativo masculino plural", syntaxis: "Sujeto de la oración de infinitivo", translatio: { es: "a los helvecios", en: "the Helvetii", zh: "赫爾維蒂人" } },
                            { textus: "ire", lemma: "eo", morphologia: "Verbo, infinitivo presente activo", syntaxis: "Verbo de la oración de infinitivo", translatio: { es: "pasar", en: "to go", zh: "通過" } },
                            { textus: "patiantur", lemma: "patior", morphologia: "Verbo, 3ª p. pl., presente deponente, subjuntivo", syntaxis: "Verbo de la subordinada completiva", translatio: { es: "permitan", en: "they should allow", zh: "允許" } },
                            { textus: ",", lemma: ",", morphologia: "Signo de puntuación", syntaxis: "Puntuación", translatio: { es: ",", en: ",", zh: "，" } },
                            { textus: "obsidesque", lemma: "obses, -que", morphologia: "Sustantivo (acusativo pl.) + Conjunción enclítica", syntaxis: "Objeto Directo de 'dent'", translatio: { es: "y que rehenes", en: "and that hostages", zh: "並且人質" } },
                            { textus: "uti", lemma: "ut", morphologia: "Conjunción subordinante (forma arcaica)", syntaxis: "Nexo (completivo)", translatio: { es: "que", en: "that", zh: "為了" } },
                            { textus: "inter", lemma: "inter", morphologia: "Preposición (+ acusativo)", syntaxis: "Preposición", translatio: { es: "entre", en: "between", zh: "在...之間" } },
                            { textus: "sese", lemma: "sui", morphologia: "Pronombre reflexivo, acusativo", syntaxis: "Complemento regido por 'inter'", translatio: { es: "sí", en: "themselves", zh: "他們自己" } },
                            { textus: "dent", lemma: "do", morphologia: "Verbo, 3ª p. pl., presente activo, subjuntivo", syntaxis: "Verbo de la subordinada completiva", translatio: { es: "se den", en: "they give", zh: "交換" } },
                            ...
                            { textus: "itinere", lemma: "iter", morphologia: "Sustantivo, ablativo neutro singular", syntaxis: "C.C. de Separación", translatio: { es: "del camino", en: "from the path", zh: "從道路上" } },
                            { textus: "Heluetios", lemma: "Helvetii", morphologia: "Sustantivo, acusativo masculino plural", syntaxis: "Objeto Directo", translatio: { es: "a los helvecios", en: "the Helvetii", zh: "赫爾維蒂人" } },
                            { textus: "prohibeant", lemma: "prohibeo", morphologia: "Verbo, 3ª p. pl., presente activo, subjuntivo", syntaxis: "Verbo", translatio: { es: "impidan el paso", en: "hinder", zh: "阻攔" } },
                            { textus: ",", lemma: ",", morphologia: "Signo de puntuación", syntaxis: "Puntuación", translatio: { es: ",", en: ",", zh: "，" } },
                            { textus: "Heluetii", lemma: "Helvetii", morphologia: "Sustantivo, nominativo masculino plural", syntaxis: "Sujeto (elíptico)", translatio: { es: "los helvecios", en: "the Helvetii", zh: "赫爾維蒂人" } },
                            { textus: ",", lemma: ",", morphologia: "Signo de puntuación", syntaxis: "Puntuación", translatio: { es: ",", en: ",", zh: "，" } },
                            { textus: "ut", lemma: "ut", morphologia: "Conjunción subordinante", syntaxis: "Nexo (final)", translatio: { es: "para", en: "to", zh: "以便" } },
                            { textus: "sine", lemma: "sine", morphologia: "Preposición (+ ablativo)", syntaxis: "Preposición", translatio: { es: "sin", en: "without", zh: "沒有" } },
                            { textus: "maleficio", lemma: "maleficium", morphologia: "Sustantivo, ablativo neutro singular", syntaxis: "Complemento regido por 'sine'", translatio: { es: "daño", en: "mischief", zh: "傷害" } },
                            { textus: "et", lemma: "et", morphologia: "Conjunción copulativa", syntaxis: "Nexo", translatio: { es: "y", en: "and", zh: "和" } },
                            { textus: "iniuria", lemma: "iniuria", morphologia: "Sustantivo, ablativo femenino singular", syntaxis: "Complemento regido por 'sine'", translatio: { es: "injusticia", en: "injury", zh: "不法行為" } },
                            { textus: "transeant", lemma: "transeo", morphologia: "Verbo, 3ª p. pl., presente activo, subjuntivo", syntaxis: "Verbo", translatio: { es: "pasen", en: "they may pass", zh: "通過" } },
                            { textus: ".", lemma: ".", morphologia: "Signo de puntuación", syntaxis: "Puntuación", translatio: { es: ".", en: ".", zh: "。" } }
                        ],
                        ...
                        translationes: {
                            ...
                            zh: "因此，他承擔了這件事，並從塞夸尼人那裡獲得了允許赫爾維蒂人通過他們領土的許可，他還促成了雙方交換人質：塞夸尼人保證不阻攔赫爾維蒂人行軍，赫爾維蒂人則保證通過時不進行任何破壞和不法行為。"
                        }
                    }
                ]
            }
